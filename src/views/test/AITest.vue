 ...
 * @LastEditTime: 2021-06-23 09:25:15
  ...
  <div class="innterface-test">
    <div class="content">
      ...
      <div class="row">
        ...
        <el-input v-model="params" placeholder="请输入接口参数" type="textarea" :autosize="{ minRows: 10, maxRows: 30 }"></el-input>
      </div>
      <div class="row">
...
<script lang="ts">
import Vue from "vue";
import { test } from "@/http/modules/common";
export default Vue.extend({
  ...
  data() {
    return {
      ...
      transactionId: "A4071SBC1",
      serviceId: "wbSimpleTransaction",
      params: '{"user_id":"u1001","module_type":"1", "basic_knowledge_id":"k1001", "page_index":1,"page_size":2}',
      response: "",
    };
  },
  computed: {
  ...
  methods: {
    ...
    async send() {
      ...
      const re: any = await test(params, this.serviceId, this.transactionId);
      console.log(re);
      if (re) {
        this.response = JSON.stringify(re);
      }
    },
  },
});
